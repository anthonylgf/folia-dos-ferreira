...
**Site ao vivo:** https://folia-dos-ferreira.github.io
...
- `_pages/` — Todo o conteúdo do site em arquivos Markdown
  ...
  - `linha-do-tempo.md` — Linha do tempo dos imperadores organizada por década (1968–2026)
...
- Após adicionar uma tabela, inclua-a em `_data/navigation.yml` no sidebar `docs`
